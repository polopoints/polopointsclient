...
void CDeal::OnSize(UINT nType, int cx, int cy)
{
	...
	if( NULL != GetSafeHwnd() ) {
		...
		if ( NULL != pst ) {
			pst->SetWindowPos( NULL ,9 , 100 , 880, 320,SWP_SHOWWINDOW ) ; 
		}
		...
		if ( NULL != pst ) {
			pst->SetWindowPos( NULL ,250 , 430 , 30, 24  ,SWP_SHOWWINDOW ) ; 
		}
...
BOOL CDeal::Create(CWnd* pParentWnd, UINT nIDTemplate, UINT nStyle, UINT nID)
{
	...
	if ( bRes ) {
		...
		m_rBtnTxdetail.SetBitmaps( IDB_BITMAP_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_BUT2 , RGB(255, 255, 255) );
		...
		m_rBtnExportTx.SetBitmaps( IDB_BITMAP_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_BUT2 , RGB(255, 255, 255) );
		...
		m_rBtnSearch.SetBitmaps( IDB_BITMAP_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_BUT2 , RGB(255, 255, 255) );
