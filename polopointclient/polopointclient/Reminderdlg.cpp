...
BOOL CReminderdlg::OnInitDialog()
{
	...
	*/
	...
	m_rBtnOk.SetBitmaps( IDB_BITMAP_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_BUT2 , RGB(255, 255, 255) );
	...
	*/
	...
	m_rBtnCancel.SetBitmaps( IDB_BITMAP_ORANGE_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_ORANGE_BUT2 , RGB(255, 255, 255) );
...
void  CReminderdlg::WriteClosConfig(int &close)
{
	if (PathFileExistsA(theApp.m_strInsPath.c_str()))
	{
		...
		strpathe +="\\polopointsclient.conf";
...
void CReminderdlg::OnBnClickedOk()
{
	...
	if (((CButton *)GetDlgItem(IDC_RADIO_NOEXIT))->GetCheck())
	{
	   ...
	   ((CpolopointclientDlg*)(theApp.m_pMainWnd))->ToTray();
