...
//	m_strText.SetWindowText(m_Text);
	...
	*/
	...
	GetDlgItem(IDC_IMAGE)->MoveWindow(nIconLeftMargin , nIconTopMargin , 41 , 41);
	...
	if ( (m_uType & MFB_OKCANCEL) == MFB_OKCANCEL ) {
		   ...
		   */
		   ...
		   m_cancel.SetBitmaps( IDB_BITMAP_ORANGE_BUT2 , RGB(255, 255, 0) , IDB_BITMAP_ORANGE_BUT1 , RGB(255, 255, 255) );
